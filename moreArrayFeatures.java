...
public class moreArrayFeatures {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Numbers2 is now: "+ numbers2);

        // Class Arrays contains a toString() method that is much more useful.
        System.out.println("Using to string method, numbers 2 is now: " + Arrays.toString(numbers2));
        ...
        System.out.println("Numbers3 is: " +Arrays.toString(numbers3));
        ...
        System.out.println("numbers2 concate numbers3 to form numbers4: " +Arrays.toString(numbers4));

        // Arrays.sort() sorts the elements of an array.
        Arrays.sort(numbers4);
        System.out.println("Sorting numbers4 array: " +Arrays.toString(numbers4));
